...
public class Dispatcher
{
	...
	protected GList<Player> listeners;
	protected static boolean db;
	
	public Dispatcher(GlacialPlugin pl)
	{
		this.pl = pl;
		this.listeners = new GList<Player>();
		Dispatcher.setDb(true);
	}
	...
	public void log(String s, String... o)
	{
		...
		pl.getDispatchListener().log("$ " + ChatColor.WHITE + pl.getName() + ": " + msg);
