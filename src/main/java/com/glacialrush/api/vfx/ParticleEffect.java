...
import com.glacialrush.api.vfx.ReflectionUtils.PackageType;
...
public enum ParticleEffect
{
	...
	public static final class ParticlePacket
	{
		...
		public void buffer(Location center, Player player)
		{
			if(GlacialAPI.getAPI().getPlayerObject(player).particleHit())
			{
