...
public class LookupNameManager extends NameManager
{
	...
	{
		Plugin owner = manager.getPlugin();
	 ...
	 * 
	 * @param client
	 *            - the client that is receiving the name.
	 * @param observedEntity
	 *            - the entity whose name we are sending.
	 * @param observedName
	 ...
	 * <p>
	 * This will be overridden by {@link #setClientName(Player, Player, String)}
	 * for individual clients.
	 * 
	 * @param observedEntity
	 *            - the player entity to rename.
	 * @param observedName
	...
	public String setGlobalName(Player observedEntity, String observedName)
	{
		...
		if(!Objects.equal(original, observedName))
			manager.updateEntity(null, observedEntity);
		return original;
	}
	 ...
	 * 
	 * @param client
	 *            - the client that will see the name change.
	 * @param observedEntity
	 *            - the player entity to rename.
	 * @param observedName
	 *            - the new name of this entity.
	...
	public String setClientName(Player client, Player observedEntity, String observedName)
	{
		...
		// See if we need to update the entity
		if(!Objects.equal(original, observedName))
			manager.updateEntity(client, observedEntity);
		return original;
	}
	 ...
	 * 
	 * @param observedEntity
	 *            - the entity whose name will be reset.
	 ...
	 * 
	 * @param autoCleanup
	 *            - TRUE to auto-clean, FALSE otherwise.
	 */
